	...
	public void dateGameMenu() {
		...
		while(true) {
			...
			if(menu == 1) {
				...
				Calendar c = calc.makeCalendar(n1, n2, n3);
				...
				if(n1 > n2) {
					...
					System.out.println(calc.leapDate(n1, n2));
				}
